                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav> 
                                <ul id="navigation">                                                                                          
                                    ...
                                    <li class="number"><a href="tel:+919967454474">Call Now For Pickup</a></li>
                                    <li>
                                    <a href="https://wa.me/9967454474/?text=Hello%20QuickWashMumbai%2C%20I%20would%20like%20to%20schedule%20a%20laundry%20pickup." target="_blank" class="whatsapp-link">
                                        <i class="fab fa-whatsapp"></i> Chat with Us Fo Pickup
                                      </a></li>
...
>>>>>>> 4e380328b0273f136ad16e4d64f00108b1f9f79d:index.php
    <main>
        <!--? slider Area Start-->
                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-9 col-md-10 col-sm-9">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">Quality laundry service in Powai since 1996.</h1>
        ...
        <!--?  Map Area start  -->
        <div class="Map-area">
            <div class="mapswrapper"><iframe width="100%" height="450" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=hanuman%20mandir%2C%20powai%20hanuman%20road%20400076&zoom=10&maptype=roadmap"></iframe><a href="https://www.lawod.com/gym-league-codes/">Gym League Codes</a><style>.mapswrapper{background:#fff;position:relative}.mapswrapper iframe{border:0;position:relative;z-index:2}.mapswrapper a{color:rgba(0,0,0,0);position:absolute;left:0;top:0;z-index:0}</style></div>
        </div>
        <!-- Map Area End -->
    </main>
